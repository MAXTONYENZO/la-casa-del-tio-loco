...
//#region node_modules/.nitro/vite/services/ssr/assets/router-bKpre_b3.js
var import_react = /* @__PURE__ */ __toESM(require_react());
var import_jsx_runtime = require_jsx_runtime();
var styles_default = "/assets/styles-Ck_xAllh.css";
		...
		children: /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
			...
			children: [
				...
				/* @__PURE__ */ (0, import_jsx_runtime.jsx)("p", {
					...
					children: "Parece que esta puerta de la mansión no existe."
				}),
	...
	return /* @__PURE__ */ (0, import_jsx_runtime.jsx)("div", {
		...
		children: /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
			...
			children: [
				...
				/* @__PURE__ */ (0, import_jsx_runtime.jsx)("p", {
					className: "mt-2 text-sm text-muted-foreground",
					children: "Intenta recargar o volver al inicio."
				}),
...
var Route$2 = createRootRouteWithContext()({
	head: () => ({
		meta: [
			...
			{
				name: "description",
				content: "Mansión exclusiva para bodas, quinceañeros y eventos corporativos. Elegancia sin aburrimiento, hasta 300 invitados. Apúntate y celebra la fiesta de tu vida."
			},
			{
				property: "og:title",
				content: "La Casa del Tío Loco"
			},
			{
				property: "og:description",
				content: "Elegancia sin aburrimiento. Fiestas inolvidables para 300 locos como tú."
			},
			{
				property: "og:type",
				content: "website"
...
var $$splitComponentImporter = () => import("./routes-RnBRAwIV.mjs");
